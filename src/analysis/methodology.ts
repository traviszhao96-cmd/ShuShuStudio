...
const NATAL_HUA_MEANING: Record<string, Record<GongName, string>> = {
  ...
  忌: {
    ...
    夫妻: '配偶不顺+我对配偶欠债般付出，非恋爱结婚，夫妻关系有波动反复',
    子女: '子女不顺+我对子女溺爱亏欠(永远觉得补偿不够)，得子迟先女后子，合伙不顺',
    财帛: '有钱但守不住(赚多花多)，守财奴性格(钱放出去心里悬)，擅理财规划',
    疾厄: '身体底子差带遗传体质，脾气直喜怒形于色直肠子',
    迁移: '出外不顺招小人，社会际遇差，外出总有遗憾',
    交友: '交友不顺+对朋友亏欠(付出再多都不够)，朋友多固执型',
    官禄: '工作事业多变动，宜创业不宜上班，事业有是非缺贵人',
    田宅: '有房产但过程波折(头期款不够要借贷)，居无定所小时常搬家，成家辛苦',
    福德: '精神层面较没福气(有钱但忙碌没时间休息)，精神劳碌操烦多',
